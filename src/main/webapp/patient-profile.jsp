...
<body>
    <div class="dashboard-layout">
        <!-- Sidebar and Top Bar common logic -->
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="PatientServlet?action=profile" class="menu-item active">
                ...
                <div class="split-right" style="padding: 0;">
                    <div class="form-header">
                        ...
                        <% if ("success".equals(request.getParameter("status"))) { %>
                            <p style="color: var(--teal-primary); font-weight: 600;">Profile updated successfully!</p>
                        <% } %>
                    </div>
                    
                    <form action="PatientServlet?action=updateProfile" method="POST">
