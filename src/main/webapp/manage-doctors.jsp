        ...
        <main class="main-content">
            ...
            <div class="data-card">
                <div class="data-header">
                    <h2 style="font-weight: 700; margin: 0;">Doctor Directory</h2>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <% for (User u : users) { %>
                                <tr>
                                    <td>#<%= u.getId() %></td>
                                    <td style="font-weight: 600;">Dr. <%= u.getFullName() %></td>
                                    <td><%= u.getEmail() %></td>
                                    <td><span class="role-badge badge-Doctor">Active</span></td>
                                    <td>
                                        <a href="AdminServlet?action=deleteUser&id=<%= u.getId() %>" 
                                           onclick="return confirm('Remove doctor?')"
                                           class="btn-primary" 
