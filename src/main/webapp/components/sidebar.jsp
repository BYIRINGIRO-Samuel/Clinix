...
<aside class="sidebar">
    ...
    <nav class="sidebar-menu">
        <a href="admin-dashboard.jsp" class="menu-item <%= request.getRequestURI().endsWith("admin-dashboard.jsp") ? "active" : "" %>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
            <span>Dashboard</span>
        </a>
        <a href="manage-users.jsp" class="menu-item <%= request.getRequestURI().endsWith("manage-users.jsp") ? "active" : "" %>">
        ...
        <a href="manage-doctors.jsp" class="menu-item <%= request.getRequestURI().endsWith("manage-doctors.jsp") ? "active" : "" %>">
        ...
        <a href="manage-patients.jsp" class="menu-item <%= request.getRequestURI().endsWith("manage-patients.jsp") ? "active" : "" %>">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            <span>Manage Patients</span>
        </a>
        <a href="manage-departments.jsp" class="menu-item <%= request.getRequestURI().endsWith("manage-departments.jsp") ? "active" : "" %>">
        ...
        <a href="reports.jsp" class="menu-item <%= request.getRequestURI().endsWith("reports.jsp") ? "active" : "" %>">
        ...
        <a href="payments.jsp" class="menu-item <%= request.getRequestURI().endsWith("payments.jsp") ? "active" : "" %>">
        ...
        <a href="system-logs.jsp" class="menu-item <%= request.getRequestURI().endsWith("system-logs.jsp") ? "active" : "" %>">
